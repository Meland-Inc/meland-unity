 ...
 * @FilePath: /Assets/Src/Module/Backpack/View/TooltipItem.cs
 */
using System;
using System.IO;
public class TooltipItem : FGUITooltip
{
    protected override void OnOpen(object userData)
    {
        ...
        try
        {
            ...
            GetLoader("icon").icon = Path.Combine(AssetDefine.PATH_ITEM_ICON, $"{drItem.Icon}.png");
        }
        catch (Exception e)
        {
